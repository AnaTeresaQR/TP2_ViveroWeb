  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        ");
            ...
            ProductsXmlManager mx = new ProductsXmlManager(getServletContext().getRealPath("plants.xml"));
            ProductsListManager ml = new ProductsListManager();
            List<Product> plantsList = ml.getTopProducts();
            for (int i = 0; i < plantsList.size(); i++) {
                Product product = plantsList.get(i);
        
      out.write("\n");
      out.write("\n");
      out.write("        <p id=\"name\"> Nombre de la planta= ");
